...
public class GetModelsQuery : IRequest<GetModelQueryDto>
{
}

public class GetModelsQueryHandler : IRequestHandler<GetModelsQuery, GetModelQueryDto>
{
    private readonly AppDbContext _context;
    private readonly FileService _fileService;

    public GetModelsQueryHandler(AppDbContext context, FileService fileService)
    {
        _context = context;
        _fileService = fileService;
    }

    public async Task<GetModelQueryDto> Handle(GetModelsQuery request, CancellationToken cancellationToken)
    {
